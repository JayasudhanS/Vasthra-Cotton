      ...
      <div className="bg-white rounded-3xl p-3 sm:p-5 md:p-6 mb-8 border-2 border-[#D4AF37]/30 shadow-lg">
        <div className="flex items-stretch justify-between gap-2.5 sm:gap-5 lg:gap-6 overflow-x-auto pb-1 sm:pb-0 scrollbar-hidden w-full">
          {links.map(l => {
            ...
            return (
              <Link
                key={l.name}
                to={l.path}
                className={`flex-1 min-w-[65px] sm:min-w-[110px] flex flex-col items-center justify-center gap-2 sm:gap-3 py-3.5 sm:py-5 px-2 sm:px-4 rounded-2xl transition-all no-underline text-center select-none ${
                  isActive
              ...
              >
                ...
                <span className="text-[11px] sm:text-base font-bold tracking-tight whitespace-nowrap">
                  {l.name}
                </span>
              </Link>
            );
          ...
          <button
            ...
            className="flex-1 min-w-[65px] sm:min-w-[110px] flex flex-col items-center justify-center gap-2 sm:gap-3 py-3.5 sm:py-5 px-2 sm:px-4 rounded-2xl transition-all cursor-pointer bg-red-50/80 hover:bg-red-100 text-red-600 border border-red-200 hover:border-red-400 hover:shadow-md text-center select-none"
          >
